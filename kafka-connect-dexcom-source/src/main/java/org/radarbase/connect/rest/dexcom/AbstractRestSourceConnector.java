...
public abstract class AbstractRestSourceConnector extends SourceConnector {
  protected DexcomRestSourceConnectorConfig config;
  ...
  public abstract DexcomRestSourceConnectorConfig getConfig(Map<String, String> conf);
