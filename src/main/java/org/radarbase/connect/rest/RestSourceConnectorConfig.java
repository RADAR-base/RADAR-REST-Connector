...
import org.radarbase.connect.rest.config.ClassRecommender;
...
import org.radarbase.connect.rest.request.SimpleRequestGenerator;
...
public class RestSourceConnectorConfig extends AbstractConfig {
  ...
  private static final Class<? extends RequestGenerator> REQUEST_GENERATOR_DEFAULT =
      SimpleRequestGenerator.class;
  private static final String REQUEST_GENERATOR_DOC_CONFIG =
      "Class to be used to generate REST requests";
  private static final String REQUEST_GENERATOR_DISPLAY_CONFIG = "Request generator class";
  ...
  static ConfigDef conf() {
    ...
    return new ConfigDef()
        ...
        .define(SOURCE_TOPIC_SELECTOR_CONFIG,
            ...
            ClassRecommender.implementations(SimpleTopicSelector.class))
        ...
        .define(SOURCE_PAYLOAD_CONVERTER_CONFIG,
            ...
            ClassRecommender.implementations(StringPayloadConverter.class, BytesPayloadConverter.class))
        ...
        .define(SOURCE_REQUEST_GENERATOR_CONFIG,
            ...
            Importance.LOW,
            REQUEST_GENERATOR_DOC_CONFIG,
            group,
            ++orderInGroup,
            ConfigDef.Width.SHORT,
            REQUEST_GENERATOR_DISPLAY_CONFIG,
            ClassRecommender.implementations(SimpleRequestGenerator.class))
        ;
  }
