...
class HuaweiRouteFactoryTest {
    ...
    companion object {
        ...
        private val LITERAL_FIELD_KEYS = listOf(
            ...
            "exerciseTimeGoal", "exercise_type", "extendData", "fall_asleep_time", "go_bed_time",
            "heart_rate_variability_rmssd", "highBodyTemperatureAlarm", "isActive", "last",
            "level", "light_sleep_time", "max", "max_breathe_rate", "max_breathrate_baseline",
            "max_heart_rate", "maxSpO2", "meal", "min", "min_breathe_rate",
            "min_breathrate_baseline", "min_heart_rate", "minSpO2", "off_bed_time",
            "on_off_bed_state", "predicted_calories", "prepare_sleep_time", "recordDay",
            ...
            "steps_target", "stepsGoal", "subStatus", "systolic_pressure_avg",
